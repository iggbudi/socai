...
import { wibDate, getWibParts, wibSlotKey, formatWibScheduledAt, formatWibLabel } from '../wibTime.js';
import { parseMarketingSchedule } from '../../features/pemasaran/domain.js';
import { getCalendarGaps } from '../../features/agent/actuator/calendar.js';
...
describe('wibTime helpers', () => {
  ...
  it('formatWibScheduledAt emits +07:00 offset', () => {
    assert.equal(formatWibScheduledAt(new Date('2026-06-05T12:00:00.000Z')), '2026-06-05T19:00:00+07:00');
  });
