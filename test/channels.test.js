...
import { buildChannelsPromptSection } from '../lib/channels/prompt.js';
...
describe('ENABLED_CHANNELS env validation', () => {
  ...
  it('accepts valid ENABLED_CHANNELS values', () => {
    ...
    assert.equal(errors.some((message) => /ENABLED_CHANNELS/.test(message)), false);
  });
});